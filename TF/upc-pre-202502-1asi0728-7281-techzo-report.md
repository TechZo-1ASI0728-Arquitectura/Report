...
<div align="center">
    <img src="https://github.com/TechZo-1ASI0728-Arquitectura/Report/blob/tb2/Resources/Chapter%20VI/Prototype/web/web-usergoal1.png?raw=true" alt="prototype 1">
</div><br>
...
<div align="center">
    <img src="https://github.com/TechZo-1ASI0728-Arquitectura/Report/blob/tb2/Resources/Chapter%20VI/Prototype/web/web-usergoal2.png?raw=true" alt="prototype 2">
</div><br>
...
<div align="center">
    <img src="https://github.com/TechZo-1ASI0728-Arquitectura/Report/blob/tb2/Resources/Chapter%20VI/Prototype/web/web-usergoal3.png?raw=true" alt="prototype 3">
</div><br><br>
...
<div align="center">
    <img src="https://github.com/TechZo-1ASI0728-Arquitectura/Report/blob/tb2/Resources/Chapter%20VI/Prototype/web/web-usergoal5.png?raw=true" alt="prototype 5">
</div><br><br>
...
<div align="center">
    <img src="https://github.com/TechZo-1ASI0728-Arquitectura/Report/blob/tb2/Resources/Chapter%20VI/Prototype/web/web-usergoal6.png?raw=true" alt="prototype 6">
</div><br><br>
...
<div align="center">
    <img src="https://github.com/TechZo-1ASI0728-Arquitectura/Report/blob/tb2/Resources/Chapter%20VI/Prototype/web/web-usergoal7.png?raw=true" alt="prototype 7">
</div><br><br>
...
<div align="center">
    <img src="https://github.com/TechZo-1ASI0728-Arquitectura/Report/blob/tb2/Resources/Chapter%20VI/Prototype/web/web-usergoal8.png?raw=true" alt="prototype 8">
</div><br><br>
...
<div align="center">
    <img src="https://github.com/TechZo-1ASI0728-Arquitectura/Report/blob/tb2/Resources/Chapter%20VI/Prototype/web/web-usergoal9.png?raw=true" alt="prototype 9">
</div><br><br>
...
<div align="center">
    <img src="https://github.com/TechZo-1ASI0728-Arquitectura/Report/blob/tb2/Resources/Chapter%20VI/Prototype/web/web-usergoal10.png?raw=true" alt="prototype 10">
</div><br><br>
...
<div align="center">
    <img src="https://github.com/TechZo-1ASI0728-Arquitectura/Report/blob/tb2/Resources/Chapter%20VI/Prototype/web/web-usergoal11.png?raw=true" alt="prototype 11">
</div><br><br>
...
<table> <tr> <th>Sprint #</th> <th>Sprint 2</th> </tr> <tr> <td colspan="2"><b>Sprint Planning Background</b></td> </tr> <tr> <td>Date</td> <td>2025-10-25</td> </tr> <tr> <td>Time</td> <td>10:00 AM</td> </tr> <tr> <td>Location</td> <td>Reunión virtual mediante Discord</td> </tr> <tr> <td>Prepared By</td> <td>Santisteban Palomino, Ian Haziel Donato</td> </tr> <tr> <td>Attendees</td> <td>Santisteban Palomino, Ian Haziel Donato / Quispe Andia, Jeremy Joel / Huamani Mandujano, Joseph Alexis / Mendoza Carrion, Mathias Andre / Criollo De La Cruz, Diego Anderson. </td> </tr> <tr> <td>Sprint n-1 Review Summary</td> <td> En la Sprint Review del Sprint 1 se validó con el Product Owner que la landing page, el frontend inicial y la primera versión funcional del backend (User y Product context) se encontraban desplegados en el ambiente de pruebas y permitían navegar el flujo básico de la plataforma. Se recibió retroalimentación sobre ajustes visuales en la landing, mejora de copys y la necesidad de priorizar, en el siguiente sprint, funcionalidades orientadas al usuario autenticado, la gestión de intercambios y la visibilidad de ONGs y suscripciones. </td> </tr> <tr> <td>Sprint n-1 Retrospective Summary</td> <td> En la retrospectiva del Sprint 1 el equipo identificó como principales aprendizajes: (1) mejorar la descomposición de las historias de usuario en tareas más pequeñas y balanceadas entre los miembros, (2) reforzar la Definition of Done incorporando pruebas unitarias, revisión de código obligatoria y despliegue en el ambiente de pruebas, y (3) optimizar la comunicación interna utilizando canales específicos en Discord por feature y registrando dailies breves cuando no fuera posible reunirse de forma síncrona. </td> </tr> <tr> <td colspan="2"><b>Sprint Goal & User Stories</b></td> </tr> <tr> <td>Sprint 2</td> <td> Desarrollar y consolidar la experiencia del usuario autenticado, la gestión completa de intercambios y la coordinación segura del encuentro, soportadas por APIs especializadas y mecanismos de moderación con IA.<br><br> En este sprint se priorizan historias orientadas a: actualización y seguridad de la cuenta (US02, US04, US09, US21), mejora del perfil y reputación del usuario (US07, US08, US17, US23, US24), gestión operativa de las publicaciones e intercambios (US11, US13, US14, US15, US18, US22), fortalecimiento de la relación con ONGs y membresías (US21, US22, US25, US26), así como la habilitación de capacidades de chat en tiempo real y moderación de imágenes con IA (US33, US34, TS02, TS03, TS04, TS06).<br><br> <b>Métrica de Cumplimiento:</b> El sprint se considerará exitoso si el 100 % de las historias de usuario y tareas técnicas seleccionadas para el Sprint 2 (US02, US04, US07, US08, US09, US11, US13, US14, US15, US17, US18, US21, US22, US23, US24, US25, US26, US33, US34, TS02, TS03, TS04 y TS06) se encuentran en estado “Done” en el tablero, integradas con sus respectivas APIs en los clientes web y móvil, sin errores críticos reportados en el ambiente de pruebas y permitiendo completar de extremo a extremo los flujos de gestión de perfil, intercambios y coordinación mediante chat. </td> </tr> <tr> <td>Sprint 2 Velocity</td> <td>77 Story Points</td> </tr> <tr> <td>Sum of Story Points</td> <td>77 Story Points</td> </tr> </table><br><br>
